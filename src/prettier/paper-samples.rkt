...
(define d-lst
  (let* (
    ...
    (list
     ...
     (list "comparison 1 (group with sp)" '(20 40 30 15 10 7) (group/cat (group/cat "(" align "1 +" sp "2" dedent ") *") sp (group/cat "(" align "3 +" sp "4 +" sp (group/cat "(" align "5 +" sp "6 +" sp "7" dedent ") +") sp "8" dedent ")")))
